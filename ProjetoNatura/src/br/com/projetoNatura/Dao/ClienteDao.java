...
public class ClienteDao {
	...
	public void cadastrarCliente(Cliente cliente){
		...
		try {
			...
			PreparedStatement stm = conexao.prepareStatement("insert into cliente (nome, endereco, telefone, cpf,email) values(?,?,?,?,?)");
	...
	public static void alterarCliente(Cliente cliente){
		...
		try {
			Connection con = Conexao.getConnection();
			PreparedStatement stm = con.prepareStatement("UPDATE cliente set nome = ? , telefone = ?, "
